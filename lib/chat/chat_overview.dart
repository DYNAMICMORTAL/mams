...
//                     return ListTile(
//                       title: Text(searchResults[index].number),
//                       subtitle: Text(
//                           '${searchResults[index].startStation} to ${searchResults[index].endStation}'),
//                     );
//                   },
//                 ),
//               ),
...
//                   Row(
//                     children: [
//                       Icon(FluentSystemIcons.ic_fluent_dock_filled),
//                       Column(
